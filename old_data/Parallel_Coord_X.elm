module Parallel_Coord_X exposing (main)
...
import TypedSvg.Attributes exposing (class, d, fill, opacity, textAnchor, transform, viewBox)
...
parallelCoodinatesPlot width height model =
    ...
    svg
        ...
        [ rect
            ...
            , TypedSvg.Attributes.InPx.width (width + 2 * padding)
            , TypedSvg.Attributes.InPx.height (height + 2 * padding)
            , fill <| Paint <| Color.rgb255 0 0 0
            ]
            []
        , style []
            [ TypedSvg.Core.text
                (".pc-line { stroke: rgba(255, 255, 255, 0.1); stroke-width: 2px; fill: none; }\n"
