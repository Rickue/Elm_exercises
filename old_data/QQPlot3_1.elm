module QQPlot3_1 exposing (main)
        ...
        sorted
            |> List.indexedMap
                (\i v ->
                    ...
                    in
                    { pointName = String.fromInt (i + 1), x = f, y = v }
                )
...
main =
    ...
    Html.div []
        ...
        , Html.p []
            [ Html.text ("Anzahl Autos in gefilterter Klasse: " ++ String.fromInt (List.length filteredCars.chosenComplete)) ]
        , Html.h3 [] [ Html.text "Quantil-Plot (cityMPG)" ]
        , qqPlotForPartition filteredCars
        ]
