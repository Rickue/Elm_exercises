module QQPlot3_2 exposing (main)
...
main =
    let
        ...
        class2Name : String
        class2Name =
            carTypeToString chosenCarType2

        class1Values =
            List.map .cityMPG filteredCars1.chosenComplete

        class2Values =
            cityValuesForCarType chosenCarType2 cars
    in
    Html.div []
        [ Html.p []
            [ Html.text ("Klasse 1: " ++ class1Name ++ " | Anzahl: " ++ String.fromInt (List.length class1Values)) ]
        , Html.p []
            [ Html.text ("Klasse 2: " ++ class2Name ++ " | Anzahl: " ++ String.fromInt (List.length class2Values)) ]
        , Html.h3 [] [ Html.text ("Quantil-Plot (cityMPG) - " ++ class1Name) ]
        , qqPlotFromValues class1Values
        , Html.h3 [] [ Html.text ("Quantil-Plot (cityMPG) - " ++ class2Name) ]
        , qqPlotFromValues class2Values
        , Html.h3 [] [ Html.text ("QQ-Plot (" ++ class1Name ++ " vs " ++ class2Name ++ ") mit Diagonale f(x)=x") ]
        , qqPlotBetweenClasses class1Name class2Name class1Values class2Values
        ]
